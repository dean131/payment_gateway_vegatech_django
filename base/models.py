...
class Pembelian(models.Model):
    ...
    status_pembelian = models.CharField(max_length=20, default='belum_bayar', choices=STATUS_CHOICES)
...
class Produk(models.Model):
    ...
    kategori_produk = models.CharField(max_length=200, default='hardware', choices=KATEGORI_CHOICES)
